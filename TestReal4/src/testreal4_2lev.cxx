...
// floating-point roundoff, for both CCTK_REAL8 and CCTK_REAL4 grid
// functions. This directly exercises CarpetX's float
// FillPatch_NewLevel/FillPatch_RemakeLevel/FillPatch_ProlongateGhosts and
// the InterpolaterT<CCTK_REAL4> prolongation operators (Phase 2).
//
...
extern "C" void TestReal4_2Lev_Check(CCTK_ARGUMENTS) {
  ...
  CCTK_VINFO("TestReal4-2lev: PASS (%d points checked, level %d)", n_checked,
             cctkGH->cctk_level);
}
