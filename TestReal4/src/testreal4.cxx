...
// a CCTK_REAL8 and a CCTK_REAL4 grid function. (TestReal2, the sibling
// thorn holding this suite's CCTK_REAL2 layer, checks the same thing for a
// binary16 grid function.)
template <typename T>
...
extern "C" void TestReal4_Check(CCTK_ARGUMENTS) {
  ...
  // Type-appropriate tolerances, taken from param.ccl (check_tolerance8/4)
